...
def _get_shared_schemas_map() -> dict[str, SharedSchema]:
    ...
    The question bank is registered here alongside the hand-written shared schemas. It is
    the same kind of artifact -- a document of named definitions referenced by pointer --
    at the granularity of a semantic question rather than a primitive, so publishing it
    needs no change downstream of this function.
    """
