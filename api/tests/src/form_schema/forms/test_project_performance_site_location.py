...
_FORM_MODULE = importlib.import_module(
    "src.form_schema.forms.project_performance_site_location.1.0.form_json"
)


def test_performance_site_component_preserves_the_native_oracle() -> None:
    ...
    assert _FORM_MODULE._PRIMARY_SITE.component_id == ("application.performance-site-location")
    assert _FORM_MODULE._ADDITIONAL_SITE.component_id == ("application.performance-site-location")
